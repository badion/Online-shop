					...
					<table id="myModalBody" class="table table-hover">
						...
						<c:forEach items="${prevProduct}" var="products">
							<tr>
								...
								<td><a class="btn btn-primary" id="clear"
									href="clearCart?productId=${products.idProduct}&idChout=${products.idCheckoutProduct}&oid=${products.idCheckout}">Remove</a></td>
							</tr>
						</c:forEach>
	...
	<div class="modal-footer">
		...
		<c:if test="${prevProduct.size() != null}">
			<form method="post" action="ordering">
				<input type="hidden" name="sum" value="${checkout.priceSum}" /> <input
					type="hidden" name="listOfShoppingCart" value="${prevProduct}" />
				<button type="submit" class="btn btn-primary">Save changes</button>
			</form>
		</c:if>
		<c:if test="${prevProduct.size() == null}">
			<a>Nothing to order</a>
		</c:if>
	</div>
</div>
			...
			<div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
				<div class="container">
					...
					<div class="navbar-collapse collapse">
						<form name="Login form" action="authorization" method="post"
							class="navbar-form navbar-right" role="form">
							<div class="form-group">
								<input type="text" placeholder="Login" name="login"
									value="${session.login}" class="form-control">
							...
							<button type="submit" name="authorization_button"
								class="btn btn-success">Sign in</button>
							<c:remove var="session_authorization_error_message"
								scope="session" />
			...
			<div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
				<div class="container">
					...
					<div class="navbar-collapse collapse">
						<form name="Login form" action="authorization" method="post"
							class="navbar-form navbar-right" role="form">
							<button type="submit" name="log_out_button"
								class="btn btn-success">Logout</button>
							<a href="userProfile" class="btn btn-warning">Profile</a> <a
								data-toggle="modal" class="btn btn-info" href="#myModal"><i
								class="glyphicon glyphicon-shopping-cart"></i> Cart(
								${prevProduct.size()} )</a>
						</form>
						<!-- 			User profile -->
					</div>
