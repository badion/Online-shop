...
jQuery.validator.addMethod("letterswithpunc", function(value, element) {
	 return this.optional(element) || /^[a-яА-Яa-zA-Z\-.,()'"\s]+$/i.test(value);
	}, "Letters or punctuation only please");
jQuery.validator.addMethod("user", function(value, element) {
	 return this.optional(element) || /^[a-яА-Яa-zA-Z-'"\s]+$/i.test(value);
	}, "Letters or punctuation only please");
jQuery.validator.addMethod("loginn", function(value, element) {
	 return this.optional(element) || /^[a-яА-Яa-zA-Z0-9\-.@_,()'"\/s]+$/i.test(value);
	}, "Letters or punctuation only please");

jQuery.validator.addMethod("integerwithslash", function(value, element) {
	 return this.optional(element) || /^[0-9\/]+$/i.test(value);
	}, "Letters or punctuation only please");

jQuery.validator.addMethod("phonen", function(value, element) {
...
jQuery.validator.addMethod("letterswithbasicpunc", function(value, element) {
	...
	jQuery.validator.addMethod("lettersonly", function(value, element) {
	 return this.optional(element) || /^[А-Яа-яЁёіїєьІЇЄЬa-zA-Z\s.]+$/i.test(value);
	}, "Letters only please");
